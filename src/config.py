# basic configuration
INPUT_FILE_OBSERVABLE_FEATURES = "../data/biological_set_raw_data_new-1.xlsx"
INPUT_FILE_EXPLAINING_FEATURES = "../data/biological_set_explaining_features_new-1.xlsx"
...
OUTPUT_FOLDER_BASE = (
    '../results/zoo_subfam_4/'
)

GROUP_NAME = "Individual"
OBSERVABLE_NAME = "observations (night)"
DATASET_NAME = "biological-dataset"
OBSERVABLE_PATTERN_NAME = "observable pattern"
OBSERVABLE_PATTERN_NAME_PLURAL = "observable patterns"
